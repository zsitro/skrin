...
gulp.task('stylus', function () {
	...
	.pipe(plugins.autoprefixer('last 2 version', 'safari 5', 'ie 9', 'opera 12.1', 'ios 6', 'android 4'), plugins.util.log('Applying autoprefixer...'))
...
gulp.task('coffee', function () {
	...
	return bundle
		.pipe(plugins.browserify(config).on('prebundle', function(bundler){
			bundler.require('./vendor/angular/angular.js', { expose: 'angular' });
